/**
 * Logo Facebook, en SVG inline.
 *
 * Dessiné plutôt que chargé : une image distante ajouterait une requête et
 * casserait le jour où l'URL bouge, et le tracé se colore avec le texte
 * (`currentColor`) comme n'importe quelle autre icône de l'app.
 */
